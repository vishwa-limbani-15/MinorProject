"""
Hospital HRM Framework - Version 3.1.1
==================================
...
def run_v3_smoke_test(
        ...
        transitions.append(
            {
                ...
                "state_length": int(len(next_state)),
                "source_before": info.get("source_before"),
                "source_after": info.get("source_after"),
                "target_before": info.get("target_before"),
                "target_after": info.get("target_after"),
                "assignment_before": info.get("assignment_before"),
                "assignment_after": info.get("assignment_after"),
            }
        )
        state = next_state
        step_no += 1
    ...
    summary = {
        "version": "3.1.1",
        "description": "V3.1.1 dynamic staff-level hospital workforce environment validation smoke test",
    ...
    transitions_path = os.path.join(output_dir, "v3_1_1_smoke_test_transitions.json")
    summary_path = os.path.join(output_dir, "v3_1_1_environment_summary.json")
    roster_path_out = os.path.join(output_dir, "v3_1_1_final_roster_after_smoke_test.csv")
